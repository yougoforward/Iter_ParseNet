...
from utils.lovasz_loss import ppss_AAF_Loss as PPSSLoss
...
def parse_args():
    ...
    parser.add_argument('--restore-from', default='./checkpoints/init/resnet101_stem.pth',
                        type=str)
    # parser.add_argument('--restore-from', default='./checkpoints/exp/abr_ppss_miou61.27.pth',
    #                     type=str)
...
def main(args):
    ...
    criterion = PPSSLoss(ignore_index=args.ignore_label, only_present=True, num_classes=args.num_classes)
