...
def get_arguments():
    ...
    parser.add_argument('--restore-from', default='./checkpoints/exp/abr_ppss_miou61.27.pth', type=str)

    parser.add_argument("--is-mirror", action="store_true")
    parser.add_argument('--eval-scale', nargs='+', type=float, default=[1.0])
    # parser.add_argument('--eval-scale', nargs='+', type=float, default=[0.5])
    # parser.add_argument('--eval-scale', nargs='+', type=float, default=[0.75])
    # parser.add_argument('--eval-scale', nargs='+', type=float, default=[1.25])
    # parser.add_argument('--eval-scale', nargs='+', type=float, default=[1.0, 1.25, 1.5])
