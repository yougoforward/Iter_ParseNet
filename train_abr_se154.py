...
def parse_args():
    ...
    # parser.add_argument('--restore-from', default='./checkpoints/init/se_resnext50_32x4d.pth', type=str)
    ...
    for epoch in range(0, args.epochs):
        ...
        if epoch %5== 0:
            ...
            if val_miou > best_val_mIoU:
                ...
                model_dir = os.path.join(args.snapshot_dir, args.method + '_miou'+str(val_miou)+'.pth')
