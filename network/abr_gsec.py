...
from modules.parse_mod import MagicModule, gsecMagicModule

BatchNorm2d = functools.partial(InPlaceABNSync, activation='none')
from modules.parse_mod import SA_upsample
...
class Decoder(nn.Module):
    def __init__(self, num_classes):
        ...
        self.layer5 = gsecMagicModule(2048, 512, 1)
        # self.saup = SA_upsample(512, 512, 128, 512)
