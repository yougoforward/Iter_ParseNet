...
class IterTrans(nn.Module):
    def __init__(self, trans_step=2, trans_unit='conv', fbody_cls=2, hbody_cls=3, part_cls=7):
...
class Decoder(nn.Module):
    def __init__(self, num_classes=7, iter_step=1, trans_step=1, fbody_cls=2, hbody_cls=3):
        ...
        self.trans_step = trans_step
        self.iter_trans = IterTrans(self.trans_step, 'conv', fbody_cls, hbody_cls, part_cls=num_classes)
