...
# from modules.oc_mod import ASPAtteModule
from modules.oc_mod import ASPOCencModule
from modules.oc_mod import ASPOCCAENCModule
...
class Decoder(nn.Module):
    def __init__(self, num_classes):
        ...
        #     BatchNorm2d(512), nn.ReLU(inplace=False),
        #     ASPOCencModule(512, 256, num_classes, 2))
        self.layer5 = ASPOCCAENCModule(2048, 256, 2, num_classes)
