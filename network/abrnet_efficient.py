...
class DecoderModule(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.conv0 = nn.Sequential(nn.Conv2d(40, 512, kernel_size=3, padding=1, dilation=1, bias=False),
...
class Decoder(nn.Module):
    def __init__(self, num_classes):
        ...
        self.layer_dsn = nn.Sequential(nn.Conv2d(112, 256, kernel_size=3, stride=1, padding=1),
                                       BatchNorm2d(256), nn.ReLU(inplace=False),
