...
class GNN(nn.Module):
    def __init__(self, in_dim=256, hidden_dim=10, cls_p=7, cls_h=3, cls_f=2):
        ...
        self.full_decomp = nn.Sequential(
            ...
            nn.Conv2d(in_dim, cls_h * hidden_dim, kernel_size=1, padding=0, stride=1, bias=False),
        ...
        self.half_decomp = nn.Sequential(
            ...
            BatchNorm2d(in_dim), nn.ReLU(inplace=False),
            nn.Conv2d(in_dim, cls_p*hidden_dim, kernel_size=1, padding=0, stride=1, bias=False),
...
class Decoder(nn.Module):
    def __init__(self, num_classes=7, hbody_cls=3, fbody_cls=2):
        ...
        self.gnn_infer=GNN_infer(in_dim=256, hidden_dim=30, cls_p=7, cls_h=3, cls_f=2)
