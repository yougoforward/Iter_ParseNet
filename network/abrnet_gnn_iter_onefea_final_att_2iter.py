...
class GNN_infer(nn.Module):
    ...
    def forward(self, xp, xh, xf):
        ...
        return xp_infer, xh_infer, xf_infer, pg_seg+pg_seg_new+p_message_seg+pg_seg_new2+p_message_seg2, hg_seg+hg_seg_new+h_message_seg+hg_seg_new2+h_message_seg2, fg_seg+fg_seg_new+f_message_seg+fg_seg_new2+f_message_seg2
