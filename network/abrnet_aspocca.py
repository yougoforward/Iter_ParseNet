...
from modules.oc_mod import ASPOCCAModule
...
class AlphaHBDecoder(nn.Module):
    def __init__(self, hbody_cls):
        ...
        self.conv0 = nn.Sequential(nn.Conv2d(512, 256, kernel_size=3, padding=1, dilation=1, bias=False),
                                   BatchNorm2d(256), nn.ReLU(inplace=False))
        self.conv1 = nn.Sequential(nn.Conv2d(256, 256, kernel_size=3, padding=1, stride=1, bias=False),
                                   BatchNorm2d(256), nn.ReLU(inplace=False),
...
class Decoder(nn.Module):
    def __init__(self, num_classes):
        ...
        #     ASPOCCAModule(512, 256, 2))
        self.layer5 = ASPOCCAModule(2048, 512, 2)
